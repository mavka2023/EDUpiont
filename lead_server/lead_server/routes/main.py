...
from lead_server.routes.attempt_router import get_attempt_router
from lead_server.routes.auth_router import get_auth_router
from lead_server.routes.calendar_router import get_calendar_router
...
async def init_app(connection_string):
    ...
    app.include_router(get_calendar_router(db_service, 'secret'))
    app.include_router(get_attempt_router(db_service, 'secret'))
